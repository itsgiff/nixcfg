...

{
  programs.git = {
    ...
    # 1. 'ignores' stays at the top level (Home Manager helper)
    ignores = [
      # Synology junk
      "@eaDir/"
      "**/@eaDir/"
    ...
    # 2. Everything else moves into 'settings'
    settings = {
      # Identity
      user = {
        name = "Paul Gifford";
      ...
      # Aliases (Note: key is 'alias', singular)
      alias = {
        # Basic aliases
        up = "pull --rebase";
      ...
      # General Config (formerly extraConfig)
